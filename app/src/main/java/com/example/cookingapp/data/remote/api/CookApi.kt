...
import com.example.cookingapp.data.remote.response.CookDto
import com.example.cookingapp.data.remote.response.CookDtoItem
import com.example.cookingapp.data.remote.response.GeminiResponse
...
interface CookApi {
    ...
    suspend fun searchRecipes(
        @Query("foodName") foodName: String, @Query("category") category: String? = null
    ): CookDto
