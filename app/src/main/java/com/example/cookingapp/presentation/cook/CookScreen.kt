...
import com.example.cookingapp.presentation.components.CookItem
import com.example.cookingapp.presentation.components.SearchBar
...
fun CookScreen(navHostController: NavHostController, isSearch: Boolean = false) {
    ...
    Surface {
        Column {
            ...
            SearchBar(
                text = searchQuery, onValueChange = { query ->
                    searchQuery = query
