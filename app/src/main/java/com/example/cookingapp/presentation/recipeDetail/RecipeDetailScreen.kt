...
import com.example.cookingapp.presentation.components.RecipeIntroductionsItem
import com.example.cookingapp.presentation.components.RecipeMaterialItem
    ...
    Box(
        ...
        Row(
            ...
            IconButton(onClick = { navHostController.popBackStack() }) {
                Icon(
                    imageVector = Icons.Rounded.ArrowBackIos, contentDescription = "Back"
                )
            }
